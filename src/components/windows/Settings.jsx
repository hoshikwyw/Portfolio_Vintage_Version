...
const Settings = () => {
    const { wallpaper, setWallpaper, theme, setTheme } = useContext(MenuContext)
            ...
            <div className="max-w-md mx-auto space-y-4">
                ...
                <fieldset style={{ border: 'var(--os-fieldset-border)', borderRadius: 'var(--os-btn-radius)', padding: '12px 14px' }}>
                    ...
                    <div className="space-y-1.5 text-[11px] mt-1" style={{ color: 'var(--os-text)' }}>
                        {[['System', 'Kayv OS'], ['Version', '1.0.0'], ['Built with', 'React + Vite + Tailwind'], ['Developer', 'Khaing Wut Yi Win']].map(([k, v]) => (
